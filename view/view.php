<?php function hmtlAccueil()
{ ?>
	<!DOCTYPE html>
<html lang="fr"> 
<head>

    <title>Accueil Mangakun Blogun</title>
...
<body>
	...
	<?php function navbar(){ ?>
	    ...
	    <h1 class="blog-name pt-lg-4 mb-0"><a href="index.html">Mangakun Blogun</a></h1>
			...
			<div class="container text-center">
				...
				<form class="signup-form form-inline justify-content-center pt-3">
					<div class="form-group">
						<label class="sr-only" for="rechercheArticle">Your email</label>
